...
module.exports = defineConfig({ //exporta a configuração do cypress
  e2e: {
    specPattern: "cypress/e2e/features/**/*.feature", //define onde ficam os arquivos de teste .feature
    ...
    baseUrl: "http://www.automationpractice.pl/index.php"//"https://www.saucedemo.com/", //define URL base do aplicativo a ser testado
  }
});
